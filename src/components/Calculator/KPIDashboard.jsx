...
const KPIDashboard = ({ kpis, previousKpis = null }) => {
  const kpiList = [
    {
    ...
    {
      label: 'Franchise Fee Revenue',
      key: 'franchiseFeeRevenue',
    ...
    },
    {
      label: 'Profit Margin',
      key: 'profitMargin',
      color: 'from-pink-500 to-pink-500/90',
      icon: FiPercent,
      format: 'percentage'
    },
    {
      ...
      key: 'perUnitRevenue',
      color: 'from-indigo-500 to-indigo-500/90',
      icon: FiTarget,
      format: 'currency'
    },
    {
      ...
      key: 'marketingFund',
      color: 'from-teal-500 to-teal-500/90',
      icon: FiPieChart,
      format: 'currency'
    },
    {
      label: 'Tech Fee Revenue',
      key: 'techFeeRevenue',
      color: 'from-cyan-500 to-cyan-500/90',
      icon: FiBarChart2,
      format: 'currency'
    }
  ];
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center space-x-3 mb-3 relative z-10">
                ...
                <h3 className="font-open-sans font-medium text-sm opacity-90">
                  {kpi.label}
                </h3>
              </div>
