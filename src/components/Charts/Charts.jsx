...
export function RevenueStackedBar({ data, title = "Revenue Breakdown by Year" }) {
  return (
...
export function RevenueDonut({ data, title = "Revenue Distribution" }) {
...
export function RevenueLine({ data, title = "Revenue Projections" }) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center space-x-3 mb-4">
        <div className="p-2 bg-primary/10 rounded-full">
...
export function BreakevenChart({ data, title = "Breakeven Analysis" }) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center space-x-3 mb-4">
        <div className="p-2 bg-primary/10 rounded-full">
...
export function SensitivityChart({ data, title = "Sensitivity Analysis" }) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center space-x-3 mb-4">
        <div className="p-2 bg-primary/10 rounded-full">
      ...
      <ResponsiveContainer width="100%" height={400}>
        ...
        >
          ...
          />
          <Bar dataKey="impact" fill="#3083DC" name="Impact on Profit" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
...
export function CashFlowChart({ data, title = "Cash Flow Analysis" }) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center space-x-3 mb-4">
        <div className="p-2 bg-primary/10 rounded-full">
